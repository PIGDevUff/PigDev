...
class CVideo:public CPigSprite{
...
CVideo(std::string nomeArq,int idJanela=0):
    CPigSprite(CGerenciadorJanelas::GetJanela(idJanela)->GetAltura(),CGerenciadorJanelas::GetJanela(idJanela)->GetLargura(),nomeArq,idJanela){
    volume = 0.5;
