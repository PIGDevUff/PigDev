...
public:
    ...
    CPIGCaractere(TTF_Font *font,int tamanhoFonte, Uint16 letra, PIGCor corFonte, int nivelOutline, PIGCor corOutline, SDL_Surface *fundo){
    ...
    void Desenha(int x, int y, PIGCor corFonte, float ang, PIGPonto2D pivoAbs,bool blend){
        glPushMatrix();
