...
GLuint PreparaTextura(int retiraFundo, PIG_Cor *corFundo=NULL){
    if (!bitmap) return 0;
...
CPIGImagem(int idSprite=-1,int altura=0,int largura=0,std::string nomeArq="",int janela=0){
    id = idSprite;
    nomeArquivo = nomeArq;
...
CPIGImagem(int idSprite,std::string nomeArq,int retiraFundo=1,PIG_Cor *corFundo=NULL,int janela=0){
    id = idSprite;
...
CPIGImagem(int idSprite,PIGOffscreenRenderer offRender, int retiraFundo=1,PIG_Cor *corFundo=NULL,int janela=0){
    id = idSprite;
    nomeArquivo = "";
...
CPIGImagem(int idSprite,CPIGImagem *imagemBase,int retiraFundo=1,PIG_Cor *corFundo=NULL,int janela=0){
    id = idSprite;
