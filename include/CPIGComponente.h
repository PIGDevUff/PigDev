...
class CPIGComponente: public CPIGImagem{
...
public:
    ...
    :CPIGImagem(idComponente,altura, largura, "",janela){
    ...
    :CPIGImagem(idComponente,nomeArq,retiraFundo,NULL,janela){
        IniciaBase(idComponente,px,py);
    ...
    void Move(double nx, double ny)override{
        CPIGImagem::Desloca(nx-pos.x,ny-pos.y);
        PosicionaLabel();
    }
