...
protected:
    ...
    static CPIGRadioBox LeParametros(int idComponente, CPIGAtributos atrib){
        ...
        if (atrib.GetString(PIG_STR_NOMEARQ,"")!=""){
            resp = new CPIGRadioBox(idComponente,atrib.GetInt(PIG_STR_LARGURA,0),atrib.GetInt(PIG_STR_ALTURALINHA,0),
            ...
            resp = new CPIGRadioBox(idComponente,atrib.GetInt(PIG_STR_LARGURA,0),atrib.GetInt(PIG_STR_ALTURALINHA,0),
                          atrib.GetString(PIG_STR_NOMEARQICONE,""),atrib.GetInt(PIG_STR_ALTURAICONE,0),atrib.GetInt(PIG_STR_LARGURAICONE,0),atrib.GetInt(PIG_STR_JANELA,0));
        }
